...
import { FileText, BookOpen, ArrowRight, TrendingUp, Search } from "lucide-react";
      ...
      <section className="py-20 bg-gray-50 border-y border-gray-100">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div><div className="text-4xl md:text-5xl font-extrabold text-[#0f172a] mb-2 tracking-tight">250+</div><div className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Épreuves</div></div>
            <div><div className="text-4xl md:text-5xl font-extrabold text-[#0f172a] mb-2 tracking-tight">500+</div><div className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Étudiants</div></div>
            <div><div className="text-4xl md:text-5xl font-extrabold text-[#0f172a] mb-2 tracking-tight">15</div><div className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Filières</div></div>
            <div><div className="text-4xl md:text-5xl font-extrabold text-[#0f172a] mb-2 tracking-tight">100%</div><div className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Gratuit</div></div>
          </div>
        </div>
      </section>
